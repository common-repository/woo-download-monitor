jQuery(document).ready(function ($) {
    ...
    var CLASSIFIED_MAKER_FILE_UPLOAD = {
        ...
        attach:function () {
            ...
            if (wdm_file_uploader.upload_enabled !== '1') {
                return
            }

            var uploader = new plupload.Uploader(wdm_file_uploader.plupload);
